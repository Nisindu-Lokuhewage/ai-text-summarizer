...
# API Key input
api_key = st.text_input("🔑 **Google Gemini API Key**", type="password", help="Get your free key from https://aistudio.google.com")
    ...
    if not api_key:
        ...
        try:
            with st.spinner("🤖 Summarizing..."):
                ...
                # ✅ THIS IS FREE - uses the 1.5 Flash model
...
st.markdown("---")
st.markdown("Powered by **Google Gemini 1.5 Flash** (Free Tier)")
